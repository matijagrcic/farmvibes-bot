...
/// <summary>
/// This class defines and handles state data that is updated from time to time as the user interacts with the bot.
/// It has one property 'data' which is dynamically updated as needed by the different parts of the data.
/// </summary>
public class ConversationData
{
    public ConversationData(JObject data)
    {
        this.data = data;
    }
