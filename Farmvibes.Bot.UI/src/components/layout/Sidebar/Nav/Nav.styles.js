...
export function getStyles({
  ...
  const navTextColor = palette.white;
  const navWidth = 280;
  ...
  const navBackgroundColor = palette.themeDarkAlt;
  const floatingNavBackgroundColor = palette.themeTertiary;
  const navItemHoverColor = semanticColors.neutralLight;
  const navGroupSeparatorItemHeight = 40;
  const navGroupSeparatorWithGroupNameHeight = 70;
  const navItemWithChildBgColor = semanticColors.themeDarkAlt;
  const navItemSelectedColor = semanticColors.neutralDark;
  ...
  return {
    ...
    navItemBarMarker: {
      ...
      backgroundColor: semanticColors.neutralTertiary,
